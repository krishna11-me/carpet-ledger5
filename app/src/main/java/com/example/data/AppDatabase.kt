...
@Database(entities = [TransactionEntity::class, CustomCarpetTypeEntity::class, CustomCarpetSizeEntity::class, CustomCategoryEntity::class, CarpetImageEntity::class], version = 7, exportSchema = false)
